...
* fyzická vrstva – SS (rozprostřené spektrum) – AFH, DS, OFDM, QAM, MIMO (multiple input, multiple output),
...
* Využívá se bezlicenčních pásem – 2,4/5/(6) GHz – za jejich použití není nutno platit státu
...
* Vyšlo ve stejný rok jako _802.11a_ a má horší vlastnosti – "krok zpět"
* Výrazně levnější – dostupné pro běžné uživatele (_802.11a_ spíše pro firmy)

### 802.11g

* V podstatě stejné parametry jako _802.11a_, ale na frekvenci 2,4 GHz
...
* Pro zařízení bez znalosti mechanismu vytvoření pseudonáhodných sekvencí se jeví jako šum
...
* Autentizace – identita uživatele – představení identity + ověření (heslo, certifikát, ...)
* Autorizace – udělelní/zakázání specifického typu služeb na základě uživatelovi autentizace
