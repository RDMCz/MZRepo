...
* Vyjadřuje, kolik entit se na vazbě podílí nebo může podílet
...
* __1:N__ – K jednomu řádku z jedné tabulky patří více řádků z druhé tabulky. Nejpoužívanější typ vazby.
...
* Povinnost účasti ve vazbě
* __0__ – nemandatorní (nepovinná)
* __1__ – mandatorní (povinná)
...
* Kniha a její výpůjčky – při odstranění knihy zaniknou výpůjčky
* Součást patří minimálně i maximálně jednomu celku
* Značení plným kosočtvercem na straně celku

---

[>>>](./SW_14_Normalizace%20databáze.MD)
