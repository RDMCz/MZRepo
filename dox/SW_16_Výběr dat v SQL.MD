...
* Operátor `LIKE` porovnává řetězce, podporuje jednoduché výrazy
...
<table><thead><tr><th>Oldest</th></tr></thead><tbody><tr><td>1459</td></tr></tbody></table>
...
```sql
SELECT Country, COUNT(CustomerID) -- Běžně vybíráme to, podle čeho se bude seskupovat + agregační funkce
FROM Customers
GROUP BY Country
...
[>>>](./SW_17_Prostředky%20pro%20návrh%20webových%20aplikací%20I..MD)
